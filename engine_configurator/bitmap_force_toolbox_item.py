...
class BitmapForceToolboxItem(IconGraphicsWidget):
    """
    This item represents bitmap force object in toolbox
    """

    def __init__(self):
        super(BitmapForceToolboxItem, self).__init__(":/images/force.png")
        self.setText("Bitmap force")
